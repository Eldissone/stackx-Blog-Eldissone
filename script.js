...
function viwesC() {
    ...
    const viewC7 = document.querySelector(".v7");
    const viewC8 = document.querySelector(".v8");
    ...
    let v7 = JSON.parse(localStorage.getItem('g'))
    viewC7.textContent = v7

    let v8 = JSON.parse(localStorage.getItem('h'))
    viewC8.textContent = v8
